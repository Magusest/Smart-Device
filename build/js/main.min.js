...
/* harmony import */ var _modules_my_modules_about__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/my-modules/about */ "./js/modules/my-modules/about.js");
/* harmony import */ var _modules_my_modules_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/my-modules/menu */ "./js/modules/my-modules/menu.js");
/* harmony import */ var _modules_my_modules_pop_up__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/my-modules/pop-up */ "./js/modules/my-modules/pop-up.js");
/* harmony import */ var _modules_my_modules_question_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/my-modules/question-form */ "./js/modules/my-modules/question-form.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_my_modules_about__WEBPACK_IMPORTED_MODULE_2__["showText"])();
  Object(_modules_my_modules_menu__WEBPACK_IMPORTED_MODULE_3__["showMenu"])();
  Object(_modules_my_modules_pop_up__WEBPACK_IMPORTED_MODULE_4__["showPopUp"])();
  Object(_modules_my_modules_question_form__WEBPACK_IMPORTED_MODULE_5__["initFormValidate"])();
...
/***/ "./js/modules/my-modules/about.js":
/*!****************************************!*\
  !*** ./js/modules/my-modules/about.js ***!
  \****************************************/
...
function showText() {
  var buttonAbout = document.querySelector('[data-button-about]');
  var hiddenTexts = document.querySelectorAll('[data-hidden-text]');
  if (buttonAbout) {
...
function showMenu() {
  var menuButtonNav = document.querySelector('[data-button-menu]');
  var menuButtonCont = document.querySelector('[data-button-menu="contacts"]');
  var menuNav = document.querySelectorAll('[data-menu]');
  var openedMenuHendler = function openedMenuHendler() {
    menuNav.forEach(function (menu) {
      menu.style.maxHeight = null;
    });
  };
  menuButtonNav.addEventListener('click', function () {
    var menu = menuButtonNav.nextElementSibling;
  ...
  menuButtonCont.addEventListener('click', function () {
    var menu = menuButtonCont.nextElementSibling;
    if (menu.style.maxHeight) {
      openedMenuHendler();
...
/***/ "./js/modules/my-modules/pop-up.js":
/*!*****************************************!*\
  !*** ./js/modules/my-modules/pop-up.js ***!
  \*****************************************/
/*! exports provided: showPopUp */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showPopUp", function() { return showPopUp; });
/* harmony import */ var _modals_focus_lock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modals/focus-lock */ "./js/modules/modals/focus-lock.js");

var popUpOpenButton = document.querySelector('[data-popup-button]');
var popUpCloseButton = document.querySelector('[data-popup-button="close"]');
var popUp = document.querySelector('[data-popup]');
var inputName = document.querySelector('[data-popup-name]');
var focusLock = new _modals_focus_lock__WEBPACK_IMPORTED_MODULE_0__["FocusLock"]();
function showPopUp() {
  ...
  var closeButtonHendler = function closeButtonHendler() {
...
/***/ "./js/modules/my-modules/question-form.js":
/*!************************************************!*\
  !*** ./js/modules/my-modules/question-form.js ***!
  \************************************************/
...
function initFormValidate() {
  var formComponents = document.querySelectorAll('[data-form-validate]');
  var numberContainers = document.querySelectorAll('[data-phone-validate]');
  ...
  formComponents.forEach(function (formComponent) {
    formComponent.addEventListener('submit', function (evt) {
      evt.preventDefault();
      showSuccess();
      console.log('work');
    });
